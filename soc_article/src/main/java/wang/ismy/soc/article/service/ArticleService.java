...
import wang.ismy.soc.article.dao.ArticleDao;
...
public class ArticleService {
    ...
    public Article findById(String id) {
		Article cache = cacheService.get("article_" + id, Article.class);
		if (cache == null) {
			Article article = articleDao.findById(id).get();
			cacheService.set("article_"+id,article);
			log.info("文章查询数据库");
			return article;
		}else {
			log.info("文章查询缓存");
